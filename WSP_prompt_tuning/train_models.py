...
def train_nn(
    ...
    if model_path:
        current_model.load_state_dict(torch.load(model_path), strict=False)
        logging.info(
    ...
    # print(current_model.whisper_model.named_parameters())
...
def parse_args():
    ...
    ASVSPOOF_DATASET_PATH = "/home/y-matsunaga/datasets/ASVspoof2021_DF_eval"
    ...
    default_model_config = "/home/y-matsunaga/deepfake-whisper-features/configs/training/whisper_frontend_mesonet_mfcc.yaml"
    parser.add_argument(
        "--config",
